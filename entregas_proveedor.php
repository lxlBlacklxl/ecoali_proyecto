...
<div class="provider-container">
  ...
  <main class="main-content">
    <header class="app-header">
      <div>
        <h1>Enviar al Centro de Distribución (CEDIS)</h1>
        <p>Programa cuándo quieres que pase el camión repartidor de EcoAli a recoger tus lotes de huevos listos.</p>
      </div>
      <button class="header-btn" onclick="abrirModalCrear()">
        <span>🚚</span> Solicitar Recogida de Huevos
      </button>
    </header>
